...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.emitting_thingy.single_curve_value_signal[float].connect(self.plot.singleCurveValueSlot)
        self.emitting_thingy.single_curve_value_signal[int].connect(self.plot.singleCurveValueSlot)
        self.show()
        self.resize(800, 600)

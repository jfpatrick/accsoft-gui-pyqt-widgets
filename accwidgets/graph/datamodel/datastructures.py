...
class PointData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Check if the point data is valid.
        """
        super().__init__()
...
class CurveData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Should the validity of the curve be checked?
        """
        super().__init__()
...
class BarData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Check if the bar is valid
        """
        super().__init__()
...
class BarCollectionData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Check if the bar collection is valid
        """
        super().__init__()
        if not isinstance(x, np.ndarray):
            x = np.array(x)
...
class InjectionBarData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Check if the Injection Bar is valid
        """
        super().__init__()
        self.x: float = x if x is not None else np.nan
        self.y: float = y if y is not None else np.nan
...
class InjectionBarCollectionData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Check if the Injection Bar Collection is valid
        """
        super().__init__()
        if not isinstance(x, np.ndarray):
            x = np.array(x)
...
class TimestampMarkerData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Check if the Timestamp Marker is valid
        """
        super().__init__()
        self.x: float = x if x is not None else np.nan
...
class TimestampMarkerCollectionData(PlottingItemData):
    ...
    def __init__(self,
        ...
        Args:
            ...
            check_validity: Check if the Timestamp Marker Collection is valid
        """
        super().__init__()
        if not isinstance(x, np.ndarray):
            x = np.array(x)

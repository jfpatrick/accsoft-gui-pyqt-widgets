...
from qtpy.QtCore import QObject, QAbstractTableModel, QModelIndex, Qt, QVariant, QLocale
from qtpy.QtWidgets import (QDialog, QPushButton, QTableView, QDialogButtonBox, QAction, QStyledItemDelegate,
                            QWidget, QStyleOptionViewItem, QComboBox, QMessageBox)
...
class UserDataColumnDelegate(QStyledItemDelegate):
    ...
    def createEditor(self, parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex) -> QWidget:
        ...
        if item_type == PropertyEdit.ValueType.ENUM:
            btn = QPushButton("Setup", parent)
            btn.clicked.connect(functools.partial(self._open_editor, index=index))
            return btn
        else:
    ...
    def setModelData(self, editor: QWidget, model: QAbstractTableModel, index: QModelIndex):
        ...
        This overrides :class:`QStyledItemDelegate` base method. It needs to be here to avoid default implementation
        being called, because we don not intend to modify model in this method.

...
if sys.version_info[1] <= 6:
    ...
    from typing import GenericMeta as _GenericMeta
else:
    # Since Python 3.7, GenericMeta has been removed
    from abc import ABCMeta as _GenericMeta


class GenericQObjectMeta(_GenericMeta, wrappertype):
    """
    Metaclass for classes that want to subclass :class:`typing.Generic` class and are :class:`QObject` subclasses.
    """

    def __init__(self, *args, **kwargs):
        _GenericMeta.__init__(self, *args, **kwargs)

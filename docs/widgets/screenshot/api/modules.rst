...
.. graphviz::
   ...
   digraph hierarchy {
     ...
     widget [label="{ScreenshotButton|+ model\l+ message\l+ source\l+ includeWindowDecorations\l+ maxMenuDays\l+ maxMenuEntries\l...|+ defaultAction()\l+ connect_rbac()\l+ disconnect_rbac()\l}"]

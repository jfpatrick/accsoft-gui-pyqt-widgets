...
.. graphviz::
   ...
   digraph hierarchy {
     ...
     widget [label="{TimingBar|+ model\l+ labels\l+ indicateHeartbeat\l+ highlightedUser\l+ renderSuperCycle\l+ showMicroSeconds\l+ color_palette\l...|+ showSuperCycle()\l+ hideSuperCycle()\l+ toggleSuperCycle()\l...}"]
     ...
     model [label="{TimingBarModel|+ domain\l+ current_basic_period\l+ last_info\l+ is_supercycle_mode\l+ supercycle\l+ cycle_count\l+ supercycle_duration\l+ current_cycle_index\l+ has_error\l+ activate\l|+ activate()\l...}"]
